...
// Only slide 0 has content — other slides are pure images
const heroSlides = [
  {
    img: droneImg,
  ...
  { img: img3, hasContent: false },
  { img: img4, hasContent: false },
  { img: img5, hasContent: false },
  { img: bgImg, hasContent: false }
];
            ...
            <div className="flex gap-3">
              {heroSlides.map((_, i) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-500 ${i === currentHero
